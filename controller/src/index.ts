...
const server = process.env.TTN_SERVER || "http://localhost:1885"
const appID = process.env.TTN_APPLICATION_ID
const apiKey = process.env.TTN_API_KEY
const devID = process.env.TTN_DEVICE_ID
...
let app = new App(server, appID, apiKey)

app.syncClock(devID).catch((err): void => {
